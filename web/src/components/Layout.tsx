...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    accentColor: 'blue',
    items: [
      { path: '/knowledge/overview', label: '总览', icon: <DashboardIcon /> },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/llm/channels', label: '渠道管理', icon: <ChannelIcon /> },
      { path: '/llm/groups-routing', label: '模型组与路由', icon: <GroupIcon /> },
      { path: '/llm/usage-billing', label: '用量与计费', icon: <DashboardTabIcon /> },
      { path: '/llm/logs-alerts', label: '日志与告警', icon: <LogListIcon /> },
    ],
  },
  {
    id: 'logs',
