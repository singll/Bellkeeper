...
func NewServices(repos *repository.Repositories, cfg *config.Config, version string) *Services {
	...
	return &Services{
		...
		LLMProxy:       NewLLMProxyService(cfg.LLMProxy, repos.LLMProxy, repos.LLMChannel, repos.LLMModelGroup, pricer, repos.LLMTokenUsage, repos.LLMRateLimit, repos.LLMConversationBinding),
